...
```bash
maya pause sess-a1b2c3d4-e5f6-g7h8-i9j0-k1l2m3n4o5p6
maya resume sess-a1b2c3d4-e5f6-g7h8-i9j0-k1l2m3n4o5p6
```
If recovery fails, terminate:
```bash
maya terminate sess-a1b2c3d4-e5f6-g7h8-i9j0-k1l2m3n4o5p6
```
...
```bash
maya audit sess-a1b2c3d4-e5f6-g7h8-i9j0-k1l2m3n4o5p6 > test_results/session_audit.txt
```
